...
### Dependencies
- Bump `dawidd6/action-download-artifact` from 11 to 15 ([#2](https://github.com/belkiss/GodotTemplateTest/pull/2), [#7](https://github.com/belkiss/GodotTemplateTest/pull/7))
