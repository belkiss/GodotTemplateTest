...
- Removed renovate for dependency management
...
### Dependencies
- Bump `dawidd6/action-download-artifact` from 11 to 17 ([#2](https://github.com/belkiss/GodotTemplateTest/pull/2), [#10](https://github.com/belkiss/GodotTemplateTest/pull/10))
